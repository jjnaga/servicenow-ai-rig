...
| `enhancements/<NUMBER>/` | Per-enhancement working folder: spec, evidence, package. **Local only — gitignored** — with one deliberate exception: `NGB-S2P-OPS/` ships in full as the repo's own worked example |
